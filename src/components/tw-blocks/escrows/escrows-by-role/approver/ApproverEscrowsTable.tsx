...
import { ApproverFilters } from "./ApproverFilters";
 ...
 * This displays all escrows where the connected wallet is the Approver
 */
export const ApproverEscrowsTable = () => {
  const {
    walletAddress,
    data,
    isLoading,
                  ...
                  <TableRow>
                    <TableCell colSpan={table.getAllLeafColumns().length}>
                      <div className="p-6 md:p-8 flex flex-col items-center justify-center text-center">
                        ...
                        <h3 className="font-medium text-foreground mb-2">
                          No escrows awaiting your review
                        </h3>
                        <p className="text-sm text-muted-foreground">
                          No escrows found where you are assigned as the Approver.
                        </p>
                      </div>
                    </TableCell>
                  </TableRow>
