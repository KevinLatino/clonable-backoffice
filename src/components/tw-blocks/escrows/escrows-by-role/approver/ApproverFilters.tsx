...
/**
 * Filters component for the Approver Workspace
 * This is similar to the regular Filters component but without the role selector
 * since the role is locked to "approver"
 */
export const ApproverFilters = ({
  title,
  engagementId,
  isActive,
  validateOnChain,
